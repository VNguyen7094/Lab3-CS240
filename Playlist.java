...
public class Playlist {
    ...
    public boolean addSongToPlaylist(Song song) {
        // Ensure song exists in one of the albums
    ...
    public void skipBackwards() {
        if (currentSong != null && playlist.size() > 1) {
            ...
            playlist.add(currentSong);  // Re-add current song to the queue
    ...
    public void skipForward() {
        if (!playlist.isEmpty()) {
            currentSong = playlist.poll();  // Remove the first song (current one)
